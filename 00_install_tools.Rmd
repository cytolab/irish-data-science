---
title: "2019-07 Check paths and install packages - Sierra Barone and Jonathan Irish"
...
```{r check_R_version_for_PC_users, echo=FALSE, results = "markup",message=FALSE}
# Check version of R and install new version if available 
# This only works for PC users
