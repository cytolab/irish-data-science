...
myumap <-
  umap(transformed.chosen.markers,  # input scaled data
       ...
       n_neighbors = 15,            # number of nearest neighbors to look at, scales with data set
       min_dist = 0.01,             # desired separation between close points in embedding space (for visualization)
